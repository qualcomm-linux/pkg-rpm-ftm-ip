# Contributing to pkg-rpm-ftm-ip
...
1. [Fork](https://github.com/qualcomm-linux/pkg-rpm-ftm-ip/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-rpm-ftm-ip.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/pkg-rpm-ftm-ip.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/pkg-rpm-ftm-ip/pulls) from your branch to `main`.
